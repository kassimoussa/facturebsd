...
@section('content')
    <div class="row mt-3">
        <div class="d-flex justify-content-between mb-3 ">
            <h3 class="fw-bold">Invoice uploading</h3>
        ...
        <div class="row">
            ...
            <form action="invoicestore" role="form" method="post" class="form" enctype="multipart/form-data">
                @csrf

                <div class="p-3">
                    <div class="card  mb-3">
                        <h4 class="card-header bg-dark text-center">Invoices</h4>
                        <div class="card-body">
                            <div class="mb-3">
